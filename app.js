...
async function recreateDB() {
  ...
  let instance1 = new Toy({ name:"Iron Man", toy_type:'Fictional', age_range:200 });
  let instance2 = new Toy({ name:"Shakthi Man", toy_type:'Hero', age_range:800 });
  let instance3 = new Toy({ name:"Doraemon", toy_type:'Comic', age_range:400 });
